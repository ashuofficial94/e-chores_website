...
<html>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="3000">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">
            <img src="../image/2.jpg" alt="Image" style="width: 100%; height: 400px">
          ...
          <div class="item">
            <img src="../image/3.jpg" alt="Image" style="width: 100%; height: 400px">
            <div class="carousel-caption">
          ...
          <div class="item">
            <img src="../image/e.png" alt="Image" style="width: 100%; height: 400px">
            <div class="carousel-caption">
              <h3>Security</h3>
              <p>And Safe.</p>
            </div>      
  ...
  <div class="container text-center">    
    <h3>Our Online Partners</h3><br><hr>
    <div class="row">
      <div class="col-sm-4">
